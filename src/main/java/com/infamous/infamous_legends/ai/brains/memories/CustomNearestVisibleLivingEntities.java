package com.infamous.infamous_legends.ai.brains.memories;
...
public class CustomNearestVisibleLivingEntities extends NearestVisibleLivingEntities {

   private final List<LivingEntity> nearbyEntities;
   private final Predicate<LivingEntity> lineOfSightTest;
   
   public CustomNearestVisibleLivingEntities(LivingEntity p_186104_, List<LivingEntity> p_186105_) {
		super(p_186104_, p_186105_);
	      ...
	      Predicate<LivingEntity> predicate = (p_186111_) -> {
	         return CustomSensor.isEntityTargetable(p_186104_, p_186111_);
	      };
