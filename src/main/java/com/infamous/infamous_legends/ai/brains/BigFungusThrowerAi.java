...
import com.infamous.infamous_legends.ai.brains.behaviours.BigFungusThrowerThrowAttack;
...
public class BigFungusThrowerAi {

	  public static Brain<?> makeBrain(BigFungusThrower p_35100_, Brain<BigFungusThrower> p_35101_) {
	   ...
	   public static void initMemories(BigFungusThrower p_35095_) {
	   ...
	   private static void initCoreActivity(BigFungusThrower p_35112_, Brain<BigFungusThrower> p_35113_) {
	   ...
	   private static void initIdleActivity(BigFungusThrower p_35120_, Brain<BigFungusThrower> p_35121_) {
	      p_35121_.addActivity(Activity.IDLE, 10, ImmutableList.of(new StartAttacking<>(BigFungusThrowerAi::findNearestValidAttackTarget), createIdleLookBehaviors(), createIdleMovementBehaviors(), new SetLookAndInteract(EntityType.PLAYER, 4)));
	   }
	   ...
	   private static void initFightActivity(BigFungusThrower p_35125_, Brain<BigFungusThrower> p_35126_) {
	      ...
	      }), new StopAtDistanceSetWalkTargetFromAttackTargetIfTargetOutOfReach(1.0F, 25.0D), new BigFungusThrowerThrowAttack(40)), MemoryModuleType.ATTACK_TARGET);
	   }
	   ...
	   public static void updateActivity(BigFungusThrower p_35110_) {
	      Brain<BigFungusThrower> brain = p_35110_.getBrain();
	   ...
	   protected static void setAngerTarget(BigFungusThrower p_149989_, LivingEntity p_149990_) {
	   ...
	   public static void maybePlayActivitySound(BigFungusThrower p_35115_) {
	   ...
	   private static void playActivitySound(BigFungusThrower p_35123_) {
