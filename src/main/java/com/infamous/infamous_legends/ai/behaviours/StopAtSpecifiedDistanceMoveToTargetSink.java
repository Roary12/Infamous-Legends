...
public class StopAtSpecifiedDistanceMoveToTargetSink extends Behavior<Mob> {
   ...
   public StopAtSpecifiedDistanceMoveToTargetSink(double stopDistance) {
      this(150, 250);
      this.stopDistance = stopDistance;
   }

   public StopAtSpecifiedDistanceMoveToTargetSink(int p_23573_, int p_23574_) {
